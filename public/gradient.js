(() => {
  if (typeof window === "undefined" || window.__gradientCanvasInitialized) {
    return;
  }
  window.__gradientCanvasInitialized = true;
          ...
          value: class {
            ...
            attachUniforms(name, uniforms) {
              ...
              if (typeof name === "undefined") {
                ...
                Object.entries(uniforms.value).forEach(([uniform, value]) => {
                  material.attachUniforms(`${name}.${uniform}`, value);
                });
              } else {
          ...
          value: class {
            ...
            update(value) {
              ...
              if (this.typeFn.indexOf("Matrix") === 0) {
                ...
                context[`uniform${this.typeFn}`](value, this.value);
              }
            }
                ...
                return (
                  ...
                  Object.entries(uniform.value)
                    .map(([structName, structUniform]) =>
                      structUniform.getDeclaration(structName, type).replace(/^uniform/, "")
                    )
                    .join("") +
  ...
  class Gradient {
    constructor() {
      ...
      e(this, "amp", 320);
      e(this, "seed", Math.floor(Math.random() * 10000));
      e(this, "freqX", 14e-5);
      e(this, "freqY", 29e-5);
      ...
      e(this, "animate", (e) => {
        ...
        if ((this.conf.playing || this.isMouseDown) /* && this.isIntersecting */) {
          requestAnimationFrame(this.animate);
        }
      });
